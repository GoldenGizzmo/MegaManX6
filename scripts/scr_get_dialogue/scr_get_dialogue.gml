...
function scr_get_dialogue() 
{
	...
	switch (dialogue) 
	{
		case "X vs Heatnix":
			...
			text[0] = character_name+", You need to relax"
			
			if page = 1 {speaking_is_right = true;} //Switch speaker
			text[1] = "KEHEHEHE I'M A CHICKEN"
			text[2] = "I'M CRAZY KEHE"
			
			if page = 3 {speaking_is_right = false;} //Switch speaker
			text[3] = "It seems you've lost your mind..."
			text[4] = "And have become Kentucky Fried..."
			break;
