...
if boss_flicker = true
{
	...
	draw_sprite_ext(sprite_index,image_index,x,y,1,image_yscale,rotate,image_blend,image_alpha);
...
//draw_sprite_ext(spr_direction,image_index,x,y,1,1,direction,image_blend,image_alpha);